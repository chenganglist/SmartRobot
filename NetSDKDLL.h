...
enum enumNetSatateEvent
{
	...
	EVENT_NVR_CHANNELS,//NVR所支持的Channels事件通知：lionel add @2013-2-26
	EVENT_NVR_IPC_STATUS,//NVR上各路IPC的状态事件通知：lionel add @2013-2-26
	EVENT_SYSTEMREBOOT_ANDRELOGINOK,//add by zfuwen 发送重启后，再次登录设备成功 @20130320
	EVENT_NETWORKRESET_ANDRELOGINOK,//add by zfuwen 发送網絡后，再次登录设备成功 @20130329
	EVENT_UPLOAD_PROCESS,//add by zfuwen 升级进度主动通知 @2013-07-10
	EVENT_DOWNLOAD_PROCESS,//add by zfuwen 下载进度主动通知 @2013-07-10
	EVENT_DOWNLOAD_RETRY_ANDRESTAR,//add by zfuwen 请求重传 @2013-07-10
};
...
enum PTZ_CMD_TYPE
{
	...
	ZOOM_IN_VALUE= 11,// 焦距变大(倍率变大) 
	ZOOM_OUT_VALUE, //12 焦距变小(倍率变小) 
	FOCUS_NEAR, //13 焦点前调 
	FOCUS_FAR, //14 焦点后调 
	IRIS_OPEN, //15 光圈扩大 
	IRIS_CLOSE,// 16 光圈缩小 
